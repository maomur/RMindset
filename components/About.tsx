    ...
    <div className="space-y-6 animate-fadeIn pb-24">
      ...
      <div className="ios-card p-8 flex flex-col items-center text-center space-y-4 bg-white shadow-xl relative overflow-hidden">
        ...
        <p className="text-base font-medium text-slate-700 leading-relaxed text-justify px-2 pt-2">
          Bienvenido a un espacio diseñado para transformar tu relación con la
          abundancia. Esta aplicación nace de una premisa poderosa:
          <span className="text-blue-600 font-bold">
            {" "}
            el control financiero no depende de cuánto ganas, sino de cómo lo
            administras.
          </span>
        </p>
      </div>
      ...
      <div className="ios-card p-6 space-y-6">
        <div className="flex items-start space-x-4">
          ...
          <div className="space-y-1">
            ...
            <p className="text-[14px] font-medium text-slate-600 leading-relaxed">
              Basada en los "frascos" de T. Harv Eker, esta herramienta ha sido
              creada por <strong>Resumen Maestro</strong> para acompañarte en tu
        ...
        <div className="flex items-start space-x-4">
          ...
          <div className="space-y-1">
            ...
            <p className="text-[14px] font-medium text-slate-600 leading-relaxed">
              Desde Sembrador de Hábitos hasta Mente Maestra, nuestra misión es
              convertir el caos en claridad. Cultivas libertad, inviertes en tu
              mente y aprendes a disfrutar sin culpa.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="ios-card p-8 bg-slate-900 text-white relative overflow-hidden">
        ...
        <p className="text-lg font-bold italic leading-tight relative z-10">
          "La disciplina es el puente hacia la libertad, y estamos aquí para
          ayudarte a construirlo, un frasco a la vez."
        </p>
        <p className="text-[10px] font-black uppercase tracking-widest mt-4 opacity-60">
          Toma el control • Diseña tu futuro
        </p>
      </div>

      {/* Social / Contact Section */}
      <div className="space-y-3">
        <h4 className="px-2 text-[14px] font-black text-gray-400 uppercase tracking-[0.2em]">
      ...
      <div className="text-center pt-4">
        <p className="text-[14px] font-black text-slate-400 uppercase tracking-[0.4em]">
          Domina tu destino
        </p>
      </div>
    </div>
